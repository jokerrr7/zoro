...
--------------------------------------------------------------------------------------------------------------
print([[
  _____ _____    _    __  __   ____  _        _    ____ _  __
 |_   _| ____|  / \  |  \/  | | __ )| |      / \  / ___| |/ /
   | | |  _|   / _ \ | |\/| | |  _ \| |     / _ \| |   | ' / 
   | | | |___ / ___ \| |  | | | |_) | |___ / ___ \ |___| . \ 
   |_| |_____/_/   \_\_|  |_| |____/|_____/_/   \_\____|_|\_\
...
sudo_users = {SUDO,1765160742,1003237899,1965297568}   
...
local Text = [[ 
『 َ𝑝𝑟𝑜𝑔𝑟𝑎𝑚𝑚𝑒𝑟 𝑠𝑜𝑢𝑟𝑐𝑒 𝑧𝑜𝑟𝑜 ‏. 』
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '『 َ𝑨.𝑩𝑨𝑯𝑱𝑨𝑻 ‏. 』𓆃️', url="t.me/Bahjat100"}}, 
} 
...
os.execute('wget https://raw.githubusercontent.com/jokerrrrrrrrrr7/zoro/main/BOYKA.lua')
...
local msg_id = msg.id_/2097152/0.5
local res = https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/bottestanubis/47&caption=' .. URL.escape(Texti).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--------------------------------------------------------------------------------------------------------------
...
if text == 'بهجت' then 
local Text = [[ 
𝙥𝙧𝙤𝙜𝙧𝙖𝙢𝙢𝙚𝙧 𝙨𝙤𝙪𝙧𝙘𝙚 𝙯𝙤𝙧𝙤
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩 ˹⋆َᴀ.ʙᴀʜَᴊᴀْᴛ ˼ 𓆪', url="http://t.me/Bahjat100"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
bot_data:set(ban_id.."AY:youtube"..msg.chat_id_,"close")
end
if text == "تفعيل اليوتيوب" and Manager(msg) then
send(msg.chat_id_, msg.id_,'تم تفعيل اليوتيوب')
bot_data:set(ban_id.."AY:youtube"..msg.chat_id_,"open")
end
...
DeleteMessage(Chat_id,{[0] = Msg_id})    
http.request("http://167.71.14.2/ytd.php?url="..kkp[1].."&token="..token.."&chat="..data.chat_id_.."&rep="..kpp[2].."&type=mp4")
end      
